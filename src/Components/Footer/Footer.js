...
const Footer = () => {
    return (
        <div className=''>
            <footer className="footer p-10 bg-base-200 text-black grid grid-cols-5">
                <div>
                ...
                <div>
                    ...
                    <a className="link link-hover">Team & Conditions</a>
                </div>
                <div>
                    ...
                    <a className="link link-hover">Wish List</a>
                    <a className="link link-hover">Add listing</a>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p className="text-black">All Rights Reserved @ Company 2022</p>
                </div>
